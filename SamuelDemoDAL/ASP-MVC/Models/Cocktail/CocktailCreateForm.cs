...
namespace ASP_MVC.Models.Cocktail
{
    public class CocktailCreateForm
    {
        ...
        [MaxLength(64, ErrorMessage = "The cocktail name may not be longer than 64 characters")]
        [MinLength(2, ErrorMessage = "The cocktail name must have at least 2 characters")]
