...
namespace ASP_MVC
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //The above line can be used to place the program in connection with a fake DB in case of DB maintenance dB or dev of features in the program testing on fakeDB
